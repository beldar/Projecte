...
parametri_retta(S, M, Q) :- S = seg(Xa,Ya,Xb,Yb), Xa =\= Xb, M is (Ya - Yb)/(Xa - Xb), Q is ((Xa * Yb) - (Xb * Ya)) / (Xa - Xb).
			nodi([ 'AO',  'Capitulo',  'DO',  'Foro',  'GEN_Obra_Pelicula',  'GEN_Obra_Serie',  'GEN_Persona_Actor',  'GEN_Persona_Director',  'GEN_Persona_Usuario',  'OP',  'Obra',  'PP',  'Persona',  'Premio',  'SP',  'Temporada',  'UF',  'UO', 'UOF']).
			archi([ arco('UOF', 'Obra') , arco('UOF', 'GEN_Persona_Usuario') , arco('UOF', 'Foro') , arco('AO', 'Obra') , arco('AO', 'GEN_Persona_Actor') , arco('DO', 'Obra') , arco('DO', 'GEN_Persona_Director') , arco('OP', 'Obra') , arco('OP', 'Premio') , arco('UO', 'Obra') , arco('UO', 'GEN_Persona_Usuario') , arco('Capitulo', 'GEN_Persona_Actor') , arco('Capitulo', 'GEN_Obra_Serie') , arco('Capitulo', 'Temporada') , arco('Temporada', 'GEN_Obra_Serie') , arco('SP', 'GEN_Obra_Serie') , arco('SP', 'GEN_Obra_Pelicula') , arco('GEN_Obra_Pelicula', 'Obra') , arco('PP', 'Premio') , arco('PP', 'Persona') , arco('UF', 'GEN_Persona_Usuario') , arco('UF', 'Foro') , arco('GEN_Obra_Serie', 'Obra') , arco('GEN_Persona_Actor', 'Persona') , arco('GEN_Persona_Director', 'Persona') , arco('GEN_Persona_Usuario', 'Persona') ]). 
soluzione(S) :- nodi(Ns), archi(As), createMatrix(28,28,Ps), disponi(Ns, As, Ps, [], S).
